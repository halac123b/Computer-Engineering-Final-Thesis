...
class transbot_driver:
    def __init__(self):
        ...
        self.bot_arm = Transbot_ARM()  # xx
        bot_arm_offset = self.bot_arm.get_arm_offset()  # xx
        ...
        vel = rospy.get_param("#!/usr/bin/env python
# encoding: utf-8
import sys
sys.path.append("/home/jetson/Transbot/transbot")
import rospy
...
class transbot_driver:
    def __init__(self):
        ...
        # self.srv_CurrentAngle = rospy.Service("/CurrentAngle", RobotArm, self.RobotArmcallback)  # xx
        # self.srv_RGBLight = rospy.Service("/RGBLight", RGBLight, self.RGBLightcallback)  # xx
        # self.srv_Buzzer = rospy.Service("/Buzzer", Buzzer, self.Buzzercallback)  # xx
        # self.srv_Headlight = rospy.Service("/Headlight", Headlight, self.Headlightcallback)  # xx
        # self.ediPublisher = rospy.Publisher('/edition', Edition, queue_size=10)  # xx
        # self.volPublisher = rospy.Publisher("/voltage", Battery, queue_size=10)  # xx
